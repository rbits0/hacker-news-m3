// From https://github.com/callstack/react-native-paper/issues/3797#issuecomment-1900914167
...
export const MaterialSwitchListItem = ({
  ...
  return (
    <List.Item
      left={() => (
        leftIcon ? <List.Icon style={{ paddingRight: leftIcon ? 8 : 0 }} icon={leftIcon} /> : null
      )}
